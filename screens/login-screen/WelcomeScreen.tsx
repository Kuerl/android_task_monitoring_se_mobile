        ...
        form === signform.none ?
          <>
            <View style={welcomeStyles.__logoquote}>
              <Animatable.Image source={__logo} style={welcomeStyles.__logoquote__logo} animation={{
                  from: {
              ...
              />
              <Text style={welcomeStyles.__logoquote__1} >Android Task Monitoring</Text>
            ...
            <View style={welcomeStyles.__sign}>
              <SignComponent sign={'SIGN IN'} form={form} setForm={(e: number) => setForm(e)} />
              <SignComponent sign={'SIGN UP'} form={form} setForm={(e: number) => setForm(e)} />
            </View>
          </>
          :
          form === signform.in ?
            <>
              <LoginScreen form={form} setAuth={(e: any) =>{setAuth(e)}} setForm={(e: number) => setForm(e)} after={false} />
            </> :
            form === signform.ins ?
              <LoginScreen setAuth={(e: any) =>{setAuth(e)}} form={form} setForm={(e: number) => setForm(e)} after={true} /> :
